...
- Knowledge Baseの情報を引用する際は、原文を長く引き写さず要点だけを短く述べること。
  出力は必ず指定された文字数上限内に収まるよう、JSON構造を壊さず完結させることを最優先にする
`.trim();
...
export const ROLE_DEFINITIONS = [
  {
    ...
    maxTokens: { triage: 500, decision: 1000 },
...
Owner承認の要否についても、Constitution 5-1条のカテゴリに該当しないか自ら注意深く判断してください。`,
  },
  {
    ...
    color: 0x4cc9f0,
    category: 'fixed',
    maxTokens: { opening: 550, revision: 400, approvalCheck: 250 },
    persona: `${COMMON_GUIDELINES}
...
場合のみ承認を省略できる)。`,
  },
  {
    ...
    color: 0x06d6a0,
    category: 'core',
    maxTokens: { opening: 550, revision: 400 },
    persona: `${COMMON_GUIDELINES}
